...
class SumDataQuery extends MySQLQuery {
    ...
    public function onRun(Connection $connection): ?string {
        return $connection->sum($this->table, $this->join !== null ? iterator_to_array($this->join) : null, $this->column, $this->where instanceof ThreadSafeArray ? iterator_to_array($this->where) : null);
    }
}